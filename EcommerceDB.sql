...
/****** Object:  Database [ecommerce-Project]    Script Date: 6/20/2025 7:45:53 PM ******/
CREATE DATABASE [ecommerce-Project]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ecommerce-Project', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\ecommerce-Project.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ecommerce-Project_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\ecommerce-Project_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ecommerce-Project] SET RECOVERY SIMPLE 
GO
